...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: [
      ...
      "Our advice: if a river crossing is your must see moment, book July to September and stay at least four nights, since crossings can't be scheduled, they depend on the herds' mood and the river's water levels.",
    ],
  },
  {
